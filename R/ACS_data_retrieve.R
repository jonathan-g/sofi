...
# ACS data download/process function
...
# table vector of ACS indicators
...
# variable vector of ACS indicators
...
# construct the ACS indicators information data frame
acs_indicator_info <- data.frame(name = name, table = table, var = var)

# function to automatically download data from ACS 5-year
...
#save ACS indicator data frame list
